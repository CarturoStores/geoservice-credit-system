...
router.get(
  ...
  async (request, response) => {
    ...
    urlBase = `https://maps.googleapis.com/maps/api/geocode/json?address=${address}&key=${api_key ||
      process.env.API_KEY}`;
    requestify
      .get(urlBase)
      .then(res => {
...
router.get(
  ...
  async (request, response) => {
    ...
    urlBase = `https://maps.googleapis.com/maps/api/timezone/json?location=${
      location.lat
    },${location.lng}&timestamp=${timestamp}&key=${api_key ||
      process.env.API_KEY}`;
    requestify
      .get(urlBase)
      .then(res => {
